<body>
  ...
  <div class="p-12 invoice-print">
    ...
    <div class="d-flex justify-content-between mb-6 row">
      ...
      <table class="table table-borderless m-0">
        <tbody>
          <tr>
            ...
            <td class="px-0 w-px-100 py-12">
              <p class="mb-2">Subtotal:</p>
              <p class="mb-2">Discount:</p>
              <p class="mb-2 pb-2 border-bottom">Tax:</p>
              <p class="mb-0 pt-2">Total:</p>
            </td>
            <td class="px-0 w-px-100 py-6 text-end">
              <p class="mb-2 fw-medium">$154.25</p>
              <p class="mb-2 fw-medium">$00.00</p>
              <p class="mb-2 pb-2 border-bottom fw-medium">$50.00</p>
              <p class="mb-0 pt-2 fw-medium">$204.25</p>
            </td>
          </tr>
        </tbody>
      </table>
