            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-sm-center align-items-start gap-6 pb-4 border-bottom">
                      ...
                      <div class="card-body">
                        ...
                        <span class="card-subtitle">IT Staff<span class="notificationRequest"> | <span class="text-primary">DPMPTSP Deli Serdang</span></span></span>
                        <div class="error"></div>
                      </div>
                    </div>
                  </div>
                    ...
                    <form id="formAccountSettings" method="GET" onsubmit="return false">
                      ...
                      <div class="row g-6">
                        <div class="form-control-validation col-md-6">
                          ...
                          <input class="form-control" type="text" id="nama_depan" name="nama_depan" value="<?php echo htmlspecialchars($r['nama_depan']) ?>" autofocus disabled/>
                        </div>
                        <div class="form-control-validation col-md-6">
                          ...
                          <input class="form-control" type="text" name="nama_belakang" id="nama_belakang" placeholder="<?php echo empty($r['nama_belakang']) ? 'Masukkan Nama Belakang' : 'Nama Belakang'; ?>"
                            value="<?php echo htmlspecialchars($r['nama_belakang'] ?? ''); ?>" disabled/>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="alamat" name="alamat"
                            ...
                            value="<?php echo htmlspecialchars($r['alamat'] ?? ''); ?>" disabled/>
                        </div>
                        <div class="col-md-6">
                          <label for="provinsi" class="form-label">Provinsi</label>
                          <select id="provinsi" name="provinsi" class="form-select" placeholder="<?php echo empty($r['provinsi']) ? '' : ''; ?>"
                            value="<?php echo htmlspecialchars($r['provinsi'] ?? ''); ?>" disabled>
                        ...
                        <div class="col-md-6">
                          ...
                          <select id="kabupaten" name="kabupaten" class="form-select" placeholder="<?php echo empty($r['kabupaten']) ? '' : ''; ?>"
                            value="<?php echo htmlspecialchars($r['kabupaten'] ?? ''); ?>" disabled>
                        ...
                        <div class="col-md-6">
                          ...
                          <select id="kecamatan" name="kecamatan" class="form-select" placeholder="<?php echo empty($r['kecamatan']) ? '' : ''; ?>"
                            value="<?php echo htmlspecialchars($r['kecamatan'] ?? ''); ?>" disabled>
                        ...
                        <div class="col-md-6">
                          ...
                          <select id="negara" name="negara" class="form-select select2" placeholder="<?php echo empty($r['negara']) ? '' : 'Alamat'; ?>"
                            value="<?php echo htmlspecialchars($r['negara'] ?? ''); ?>" disabled>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="kode_pos" name="kode_pos" placeholder="20143" maxlength="6" placeholder="<?php echo empty($r['kode_pos']) ? '20143' : ''; ?>"
                            value="<?php echo htmlspecialchars($r['kode_pos'] ?? ''); ?>" disabled/>
                        </div>
                        <div class="col-md-6">
                          <label for="bahasa" class="form-label">Bahasa</label>
                          <select id="bahasa" name="bahasa" class="form-select select2" placeholder="<?php echo empty($r['bahasa']) ? '' : ''; ?>"
                            value="<?php echo htmlspecialchars($r['bahasa'] ?? ''); ?>" disabled>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="mb-0 mb-6 col-12">
                      <div class="alert alert-warning">
                        <h5 class="mb-1 alert-heading">Apakah kamu yakin ingin menonaktifkan akun ini?</h5>
                        <p class="mb-0">Setelah Anda menonaktifkan akun, anda dapat menghubungi admin untuk mengaktifkannya kembali. Harap pastikan keputusan Anda.</p>
                      </div>
                    </div>
                    <form id="formAccountDeactivation" onsubmit="return false">
                      <div class="my-8 ms-2 form-check">
                        <input class="form-check-input" type="checkbox" name="accountActivation" id="accountActivation" required />
                        <label class="form-check-label" for="accountActivation">Saya setuju ingin menonaktifkan akun ini</label>
                      </div>
