              ...
              <li class="me-3 me-xl-2 nav-item dropdown-notifications navbar-dropdown dropdown">
                ...
                <ul class="p-0 dropdown-menu dropdown-menu-end">
                  <li class="border-bottom dropdown-menu-header">
                    <div class="d-flex align-items-center py-3 dropdown-header">
                      <h6 class="me-auto mb-0">Notifikasi</h6>
                      <div class="d-flex align-items-center mb-0 h6">
                        <span class="bg-label-primary me-2 badge"></span>
                        <a href="javascript:void(0)" class="p-2 dropdown-notifications-all" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark all as read"><i class="text-heading bx-envelope-open icon-base bx"></i></a>
                      </div>
                    </div>
                  </li>
                      ...
                      <li class="list-group-item list-group-item-action dropdown-notifications-item">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <h6 class="mb-0 small">Halo, Selamat Datang 🎉</h6>
