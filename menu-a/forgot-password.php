...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($user) {
    ...
    $pesan = "Hello, {$user['username']}.\nClick this link to reset your password:\n$reset_link\nLink active for 1 hour.";
    ...
    $notif = '<div class="alert alert-success" role="alert">Reset Password link has been sent to your WhatsApp!</div>';
  } else {
    $notif = '<div class="alert alert-danger" role="alert">WhatsApp number not found!</div>';
  }
}
?>
...
<head>
  ...
  <title>Forgot Password - International Elite</title>
      ...
      <div class="py-4 authentication-inner">
        ...
        <div class="card" style="border-radius: 10px;">
          <div class="card-body">
            ...
            <p class="mb-4">Enter your WhatsApp number and we will send instructions to reset your password</p>
            <form id="formAuthentication" class="mb-3" method="POST">
              <div class="mb-3">
                <label for="nomorwa" class="form-label">WhatsApp Number</label>
                <input type="text" class="form-control" id="nomorwa" name="nomorwa" placeholder="Enter your WhatsApp number" autofocus required />
              </div>
              <button class="d-grid w-100 btn btn-primary">Send Reset Link</button>
            </form>
