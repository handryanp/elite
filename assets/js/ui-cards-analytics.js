(() => {
  ...
  var p = {
    ...
    h = {
      ...
      yaxis: {
        labels: { style: { colors: t, fontSize: "15px", fontFamily: r } },
      },
      responsive: [
        {
          breakpoint: 1441,
    ...
    h = {
      ...
      series: [
        {
          data: [
            3350, 3350, 4800, 4800, 2950, 2950, 1800, 1800, 3750, 3750, 5700,
            5700,
          ],
        },
      ],
    ...
    h = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            name: { offsetY: 55, color: t, fontSize: "13px", fontFamily: r },
            value: {
              offsetY: -10,
              color: e,
              fontSize: "24px",
    ...
    h = {
      ...
      plotOptions: {
        radialBar: {
          ...
          dataLabels: {
            name: { offsetY: 15, color: i, fontSize: "15px", fontFamily: r },
            value: {
              offsetY: -20,
              color: e,
              fontSize: "24px",
    ...
    h = {
      ...
      xaxis: {
        categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
        labels: { style: { fontSize: "13px", fontFamily: r, colors: t } },
        axisTicks: { show: !1 },
        axisBorder: { show: !1 },
      },
      yaxis: {
  ...
  let f = document.querySelector("#horizontalBarChart"),
    y = {
      ...
      yaxis: {
        max: 35,
        labels: { style: { colors: [t], fontFamily: r, fontSize: "13px" } },
      },
      tooltip: {
        enabled: !0,
        style: { fontSize: "12px" },
