document.addEventListener("DOMContentLoaded", function (e) {
  ...
  var s = document.querySelectorAll(".chart-progress"),
    ...
    n = {
      ...
      labels: ["Diterima", "Masuk", "Ditolak", "Ditangguhkan"],
      series: [80, 45, 30, 40],
      colors: [
  ...
  l &&
    ...
    c &&
      ...
      registerCursorTracker({ input: c, delimiter: "/" })),
    d &&
      d.forEach(function (r) {
        r.addEventListener("input", (e) => {
          e = e.target.value.replace(/\D/g, "");
          r.value = formatNumeral(e, { numeral: !0, numeralPositiveOnly: !0 });
        });
      });
});
