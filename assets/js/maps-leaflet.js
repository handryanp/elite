(() => {
  var e = {
    ...
    t =
      (document.getElementById("basicMap") &&
        ((t = L.map("basicMap").setView([42.35, -71.08], 10)),
        L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
          attribution:
            'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
          maxZoom: 18,
        }).addTo(t)),
      document.getElementById("shapeMap"));
  if (
    (t &&
      ((t = L.map("shapeMap").setView([51.5, -0.09], 12)),
      L.marker([51.5, -0.09]).addTo(t),
    ...
    (t = document.getElementById("dragMap")) &&
      ((t = L.map("dragMap").setView([48.817152, 2.455], 12)),
    ...
    (t = document.getElementById("userLocation")))
  ) {
    let o = L.map("userLocation").setView([42.35, -71.08], 10);
    o.locate({ setView: !0, maxZoom: 16 }),
      o.on("locationfound", function (e) {
        var t = e.accuracy;
        L.marker(e.latlng)
          .addTo(o)
          .bindPopup(
  ...
  document.getElementById("customIcons") &&
    ((t = L.map("customIcons").setView([51.5, -0.09], 10)),
    (o = L.icon({
    ...
    L.marker([51.5, -0.09], { icon: a }).addTo(t),
    L.marker([51.4, -0.51], { icon: o }).addTo(t),
    L.marker([51.49, -0.45], { icon: r }).addTo(t),
    L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
      attribution:
        'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
      maxZoom: 18,
  ...
  var o,
    r,
    a = document.getElementById("geoJson");
  a &&
    ((o = L.map("geoJson").setView([44.2669, -72.576], 3)),
    L.geoJson(e).addTo(o),
    L.geoJson(e, {
      style: function (e) {
        return {
    ...
    document.getElementById("layerControl") &&
      ((r = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO.")),
      (t = L.marker([39.74, -104.99]).bindPopup("This is Denver, CO.")),
      (a = L.marker([39.73, -104.8]).bindPopup("This is Aurora, CO.")),
      (e = L.marker([39.77, -105.23]).bindPopup("This is Golden, CO.")),
      (o = L.layerGroup([r, t, a, e])),
      (r = L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
        maxZoom: 18,
      ...
      (a = L.map("layerControl", {
        center: [39.73, -104.99],
        zoom: 10,
        layers: [r, o],
      })),
      L.control
        .layers({ OpenStreetMap: r, "OpenStreetMap.HOT": t }, { Cities: o })
        .addTo(a),
