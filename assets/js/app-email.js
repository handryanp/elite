document.addEventListener("DOMContentLoaded", function () {
  {
    ...
    let a = {
        ...
        emailFilterByFolders: Array.from(
        ...
        emailFilterFolderLists: Array.from(
          document.querySelectorAll(".email-filter-folders li")
        ),
        emailListItemActions: Array.from(
      ...
      e =
        ...
        a.emailSearch &&
          a.emailSearch.addEventListener("keyup", (e) => {
    ...
    if (
      (a.toggleBCC &&
        a.toggleBCC.addEventListener("click", () => e(".email-compose-bcc")),
      a.toggleCC &&
        a.toggleCC.addEventListener("click", () => e(".email-compose-cc")),
      ...
      a.emailListDelete &&
        a.emailListDelete.addEventListener("click", () => {
          a.emailListItemInputs.forEach((e) => {
            e.checked && e.closest("li.email-list-item").remove();
          }),
            (a.selectAllEmails.indeterminate = !1),
            (a.selectAllEmails.checked = !1),
            0 === a.emailListItems.length &&
              a.emailListEmpty.classList.remove("d-none");
        }),
      a.emailListRead &&
        a.emailListRead.addEventListener("click", () => {
          a.emailListItemInputs.forEach((e) => {
            e.checked &&
              ((e.checked = !1),
              (e = e.closest("li.email-list-item")).classList.add(
                "email-marked-read"
              ),
              (e = e.querySelector(
                ".email-list-item-actions li"
              )).classList.replace("email-read", "email-unread"),
              e
                .querySelector("i")
                .classList.replace("bx-envelope-open", "bx-envelope"));
          }),
            (a.selectAllEmails.indeterminate = !1),
            (a.selectAllEmails.checked = !1);
        }),
      ...
      a.refreshEmails.addEventListener("click", () => {
        Block.standard(l, {
          backgroundColor:
            "rgba(" + window.Helpers.getCssVar("black-rgb") + ", 0.1)",
          svgSize: "0px",
        });
        var e = document.createElement("div"),
          t =
            (e.classList.add("spinner-border", "text-primary"),
            e.setAttribute("role", "status"),
            document.querySelector(".email-list .notiflix-block"));
        t && t.appendChild(e),
          setTimeout(() => {
            (i.settings.suppressScrollY = !1), Block.remove(l);
          }, 1e3),
    ...
    (r = i ? i.querySelector(".scroll-to-reply") : null) &&
      i &&
      r.addEventListener("click", () => {
        0 === i.scrollTop &&
          i.scrollTo({ top: i.scrollHeight, behavior: "smooth" });
      }),
      a.emailFilterFolderLists &&
        a.emailFilterFolderLists.forEach((e) => {
          e.addEventListener("click", () => {
            a.emailViewContainer.classList.remove("show");
          });
        }),
      a.emailListItemActions &&
        a.emailListItemActions.forEach((l) => {
          l.addEventListener("click", (e) => {
            e.stopPropagation();
            var t,
              e = l.closest("li.email-list-item");
            l.classList.contains("email-delete")
              ? (e.remove(),
                document.querySelectorAll(".email-list-item").length ||
                  a.emailListEmpty.classList.remove("d-none"))
              : (l.classList.contains("email-read") ||
                  l.classList.contains("email-unread")) &&
                ((t = l.querySelector("i")),
                e.classList.toggle(
                  "email-marked-read",
                  l.classList.contains("email-read")
                ...
                t.classList.toggle("bx-envelope-open"),
                t.classList.toggle("bx-envelope"));
          });
        });
  }
});
