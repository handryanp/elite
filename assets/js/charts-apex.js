(() => {
  var e = config.colors.cardColor,
    ...
    a = config.fontFamily;
  const i = { series1: "#826af9", series2: "#d2b0ff", bg: "#f8d3ff" },
    l = {
      series1: "#fee802",
      series2: "#3fd0bd",
      series3: "#826bf8",
    ...
    n = { series1: "#29dac7", series2: "#60f2ca", series3: "#a5f8cd" };
  function c(e, o) {
    let r = 0;
    for (var t = []; r < e; ) {
  ...
  var d = document.querySelector("#lineAreaChart"),
    h = {
      chart: {
        height: 400,
        type: "area",
    ...
    h = {
      ...
      plotOptions: {
        bar: {
          columnWidth: "15%",
          colors: {
            backgroundBarColors: [i.bg, i.bg, i.bg, i.bg, i.bg],
    ...
    h = {
      ...
      legend: {
        ...
        horizontalAlign: "start",
        labels: { colors: t, useSeriesColors: !1 },
        markers: { offsetY: 0, offsetX: -3, shape: "circle" },
        itemMargin: { vertical: 3, horizontal: 10 },
      },
      stroke: { curve: "smooth", width: 4, lineCap: "round", colors: [e] },
      series: [
        { name: "SUN", data: c(24, { min: 0, max: 60 }) },
        { name: "MON", data: c(24, { min: 0, max: 60 }) },
        { name: "TUE", data: c(24, { min: 0, max: 60 }) },
        { name: "WED", data: c(24, { min: 0, max: 60 }) },
        { name: "THU", data: c(24, { min: 0, max: 60 }) },
        { name: "FRI", data: c(24, { min: 0, max: 60 }) },
        { name: "SAT", data: c(24, { min: 0, max: 60 }) },
      ],
      xaxis: {
    ...
    d = {
      chart: { height: 348, type: "radialBar" },
      colors: [l.series1, l.series2, l.series4],
      plotOptions: {
        radialBar: {
          size: 185,
          hollow: { size: "40%" },
          ...
          dataLabels: {
            name: { fontSize: "2rem", fontFamily: a },
            value: { fontSize: "1.2rem", color: t, fontFamily: a },
            total: {
              show: !0,
              fontWeight: 400,
              fontSize: "1.3rem",
    ...
    h =
      (null !== e && new ApexCharts(e, d).render(),
    ...
    d =
      (null !== h && new ApexCharts(h, e).render(),
      document.querySelector("#donutChart")),
    s = {
      chart: { height: 357.8, type: "donut" },
  ...
  null !== d && new ApexCharts(d, s).render();
})();
