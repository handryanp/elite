(() => {
  ...
  if (null !== l) {
    var s = l.querySelector("#wizard-property-listing-form"),
      u = s.querySelector("#personal-details"),
      c = s.querySelector("#property-details"),
      d = s.querySelector("#property-features"),
      p = s.querySelector("#property-area"),
      m = s.querySelector("#price-details"),
      g = [].slice.call(s.querySelectorAll(".btn-next")),
