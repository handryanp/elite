document.addEventListener("DOMContentLoaded", function (o) {
  ...
  (p =
    ((d = isDarkStyle
      ? ((s = "dark"), (n = "#333457"), (l = "#3c3e75"), "#484b9b")
      : ((s = ""), (n = "#ededff"), (l = "#d5d6ff"), "#b7b9ff")),
    "#696cff")),
  ...
  var y = document.querySelectorAll(".chart-progress"),
    ...
    g = {
      ...
      series: [
        { name: "Last Month", data: [20, 54, 20, 38, 22, 28, 16, 19, 11] },
        { name: "This Month", data: [20, 32, 22, 65, 40, 46, 34, 70, 75] },
      ],
    ...
    g = {
      chart: { type: "bar", height: 235, stacked: !0, toolbar: { show: !1 } },
      series: [
      ...
      xaxis: {
        ...
        labels: {
          show: !0,
          style: { colors: t, fontSize: "15px", fontFamily: c },
        },
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
      },
    ...
    g = {
      ...
      series: [{ data: [340, 340, 300, 300, 240, 240, 320, 320, 370] }],
      xaxis: {
        show: !1,
        lines: { show: !1 },
        labels: { show: !1 },
    ...
    g = {
      ...
      plotOptions: {
        heatmap: {
          ...
          colorScale: {
            ranges: [
              { from: 0, to: 1e3, name: "1k", color: n },
              { from: 1001, to: 2e3, name: "2k", color: l },
              { from: 2001, to: 3e3, name: "3k", color: d },
              { from: 3001, to: 4e3, name: "4k", color: p },
            ],
          },
        },
      },
      dataLabels: { enabled: !1 },
      stroke: { width: 4, colors: [e] },
      legend: { show: !1 },
      grid: {
        show: !1,
        padding: { top: -10, left: 16, right: -15, bottom: 0 },
      },
      xaxis: {
        labels: {
          show: !0,
      ...
      yaxis: {
        labels: { style: { colors: t, fontSize: "15px", fontFamily: c } },
      },
      responsive: [
        {
          breakpoint: 1441,
    ...
    g = {
      ...
      plotOptions: {
        radialBar: {
          ...
          track: { strokeWidth: "50%", background: i },
          dataLabels: {
            show: !0,
            name: {
              offsetY: 60,
