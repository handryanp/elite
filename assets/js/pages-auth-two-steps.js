document.addEventListener("DOMContentLoaded", function () {
  {
    var e = document.querySelector(".numeral-mask-wrapper");
          ...
          t.addEventListener("keyup", (e) => {
            /^\d$/.test(e.key)
              ? t.nextElementSibling &&
                t.value.length === parseInt(t.getAttribute("maxlength")) &&
      ...
      let e = o.querySelectorAll(".numeral-mask"),
        t = () => {
          let t = !0,
            n = "";
          e.forEach((e) => {
            "" === e.value && (t = !1), (n += e.value);
          }),
            (o.querySelector('[name="otp"]').value = t ? n : "");
        };
      e.forEach((e) => {
