$(function () {
  ...
  (() => {
    ...
    if (
      null !== (e = document.querySelector(".wizard-vertical-icons-example"))
    ) {
    ...
    if (null !== (e = document.querySelector(".wizard-modern-icons-example"))) {
      (t = [].slice.call(e.querySelectorAll(".btn-next"))),
        (r = [].slice.call(e.querySelectorAll(".btn-prev"))),
        (c = e.querySelector(".btn-submit"));
      let l = new Stepper(e, { linear: !1 });
