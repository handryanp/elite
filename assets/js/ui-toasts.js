document.addEventListener("DOMContentLoaded", function (e) {
  let t = document.querySelector(".toast-ex"),
    s = document.querySelector(".toast-placement-ex"),
    n = document.querySelector("#showToastAnimation"),
    o = document.querySelector("#showToastPlacement"),
    i,
    c,
    a,
    l,
  ...
  function d(e) {
    e &&
      ...
      (s &&
        ...
        DOMTokenList.prototype.remove.apply(s.classList, a)),
      t && t.classList.remove(i, c),
      e.dispose());
  }
  n &&
    (n.onclick = function () {
      l && d(l),
        ...
        t.classList.add(i, c),
        (l = new bootstrap.Toast(t)).show();
    }),
    o &&
      (o.onclick = function () {
        r && d(r),
          (i = document.querySelector("#selectTypeOpt").value),
          (a = document.querySelector("#selectPlacement").value.split(" ")),
          s.classList.add(i),
          DOMTokenList.prototype.add.apply(s.classList, a),
          (r = new bootstrap.Toast(s)).show();
      });
  let u = -1;
  ...
  document.getElementById("showNotification").addEventListener("click", () => {
    var e =
      ...
      t = document.getElementById("dismissible").checked,
      s = document.getElementById("ripple").checked,
      n = document.getElementById("duration").value,
      n = n ? parseInt(n) : 3e3,
      o = document.querySelector('input[name="positiony"]:checked').value,
      o = {
        x: document.querySelector('input[name="positionx"]:checked').value,
        y: o,
      },
      n = {
        type: document.querySelector('input[name="notificationType"]:checked')
          .value,
        message: e,
        duration: n,
        dismissible: t,
    ...
    setTimeout(() => {
      var e = document.getElementById("okBtn"),
        t = document.getElementById("surpriseBtn");
      e &&
        ...
        t &&
          t.addEventListener("click", () => {
            p.success("Surprise! This is a new message.");
          });
    }, 100),
      p.open(n);
  }),
