(() => {
  ...
  e && e.flatpickr({ monthSelectorType: "static", static: !0 }),
    t && t.flatpickr({ enableTime: !0, noCalendar: !0, static: !0 }),
    a && a.flatpickr({ enableTime: !0, dateFormat: "Y-m-d H:i", static: !0 }),
    r &&
      r.flatpickr({
        weekNumbers: !0,
        enableTime: !0,
    ...
    null != typeof i && i.flatpickr({ mode: "range", static: !0 }),
    n &&
  ...
  $(function () {
    ...
    t.length && t.timepicker({ orientation: isRtl ? "r" : "l" }),
      a.length &&
        a.timepicker({
          minTime: "2:00pm",
          maxTime: "7:00pm",
      ...
      i.length &&
        i.timepicker({ timeFormat: "H:i:s", orientation: isRtl ? "r" : "l" }),
      n.length && n.timepicker({ step: 15, orientation: isRtl ? "r" : "l" }),
      e.length &&
        e.timepicker({
          show: "24:00",
          timeFormat: "H:i:s",
