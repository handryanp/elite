          ...
          !(function (e) {
            ...
            "classList" in document.createElement("_") ||
              (function (t) {
                if ("Element" in t) {
                  ...
                  if (o.defineProperty) {
                    var r = { get: l, enumerable: !0, configurable: !0 };
                    try {
                      o.defineProperty(n, i, r);
                    } catch (e) {
                      (void 0 !== e.number && -2146823252 !== e.number) ||
                        ((r.enumerable = !1), o.defineProperty(n, i, r));
                    }
            ...
            function v() {
              ...
              (this.options.source.data || this.options.source.search) &&
                (e = Object.values(this.selectpicker.optionValuesDataMap));
            ...
            var O,
              ...
              B = 38,
              R = 40,
              j = window.Dropdown || bootstrap.Dropdown;
            function U() {
              var t;
              try {
            ...
            var te = function (t, i) {
              var s = this;
              b.useDefault ||
                ((e.valHooks.select.set = b._set), (b.useDefault = !0)),
                (this.$element = e(t)),
            ...
            function ie(i) {
              ...
              if (([].shift.apply(n), !V.success)) {
                try {
                  ...
                  te.BootstrapVersion
                    ? (V.full = te.BootstrapVersion.split(" ")[0].split("."))
                    : (V.full = [V.major, "0", "0"]);
                }
                  ...
                  if ((r.title && (r.placeholder = r.title), l)) {
                    ...
                    (p.template = e.extend(
                      ...
                      (p.source = e.extend(
                        ...
                        te.DEFAULTS.source,
                        e.fn.selectpicker.defaults
                          ? e.fn.selectpicker.defaults.source
                          : {},
                        r.source
                      )),
              ...
              (te.prototype = {
                ...
                init: function () {
                  ...
                  _++,
                    ...
                    s.classList.contains("show-tick") &&
                    ...
                    if (s) o = this.$menuInner[0].scrollTop;
                      ...
                      if ("number" == typeof r && !1 !== n.options.size) {
                        ...
                        d &&
                          (o =
                            d -
                            (n.sizeInfo.menuInnerHeight + n.sizeInfo.liHeight) /
                              2);
                      }
                    }
                  function h(e, i) {
                    var s,
                      ...
                      f,
                      m,
                      v = n.selectpicker.current.data.length,
                      g = [],
                      b = !0,
                      w = n.isVirtual();
                    ...
                    for (var k = 0; k < o; k++) {
                      ...
                      void 0 === c &&
                        e - 1 <=
                          n.selectpicker.current.data[I - 1].position -
                    ...
                    if (
                      ...
                      (r = Math.min(o - 1, c + 1)),
                      (n.selectpicker.view.position0 =
                        !1 === w ? 0 : Math.max(0, g[l][0]) || 0),
                      (n.selectpicker.view.position1 =
                        !1 === w ? v : Math.min(v, g[r][1]) || 0),
                      (p =
                        d[0] !== n.selectpicker.view.position0 ||
                        d[1] !== n.selectpicker.view.position1),
                      void 0 !== n.activeElement &&
                        (i &&
                          (n.activeElement !== n.selectedElement &&
                            n.defocusItem(n.activeElement),
                          (n.activeElement = void 0)),
                        n.activeElement !== n.selectedElement &&
                          n.defocusItem(n.selectedElement)),
                      void 0 !== n.prevActiveElement &&
                        n.prevActiveElement !== n.activeElement &&
                        n.prevActiveElement !== n.selectedElement &&
                        n.defocusItem(n.prevActiveElement),
                          ...
                          n.options.sanitize &&
                            ...
                            (z =
                              n.selectpicker.current.data[
                                k + n.selectpicker.view.position0
                              ]) &&
                            z.content &&
                            !z.sanitized &&
                            (O.push(T), (z.sanitized = !0)),
                            $.appendChild(D);
                        }
                        if (
                          (n.options.sanitize &&
                            ...
                            ? ((y =
                              ...
                              (x =
                                n.selectpicker.view.position1 > v - 1
                                  ? 0
                                  : n.selectpicker.current.data[v - 1]
                                      .position -
                                    n.selectpicker.current.data[
                                      n.selectpicker.view.position1 - 1
                                    ].position),
                              (E.firstChild.style.marginTop = y + "px"),
                              (E.firstChild.style.marginBottom = x + "px"))
                            : ((E.firstChild.style.marginTop = 0),
                          ...
                          if (
                            ...
                            N > n.sizeInfo.menuInnerInnerWidth &&
                              ((n.sizeInfo.menuInnerInnerWidth = N),
                              (E.firstChild.style.minWidth =
                                n.sizeInfo.menuInnerInnerWidth + "px")),
                      ...
                      if (
                        ((!t && n.options.source.data) ||
                          (t && n.options.source.search)) &&
                        n.selectpicker.current.hasMore &&
                        c === o - 1 &&
                        e > 0
                      ) {
                        var H =
                          Math.floor(
                            (c * n.options.chunkSize) /
                              n.options.source.pageSize
                          ) + 2;
                        n.fetchData(
                          function () {
                            n.render(),
                          ...
                          t ? "search" : "data",
                          H,
                          t ? n.selectpicker.search.previousValue : void 0
                        );
                      }
                    }
                    if (
                      ...
                      if (t && i) {
                        var M,
                          P = 0;
                        n.selectpicker.view.canHighlight[P] ||
                          (P =
                            1 +
                ...
                buildData: function (t, i) {
                  ...
                  var d = t
                    ? t.filter(ee, this)
                    : this.$element[0].querySelectorAll("select > *" + o);
                  function h(e) {
                    var t = l[l.length - 1];
                    (t && "divider" === t.type && (t.optID || e.optID)) ||
                      (((e = e || {}).type = "divider"), l.push(e));
                  }
                  function p(i, o) {
                    if (
                      (((o = o || {}).divider = n(i, "divider")),
                      !0 === o.divider)
                    )
                      h({ optID: o.optID });
                    else {
                      ...
                      o.optID && (p = "opt " + p),
                        ...
                        !1 !== t &&
                          (s.selectpicker.optionValuesDataMap[o.value]
                            ? (o = e.extend(
                                s.selectpicker.optionValuesDataMap[o.value],
                                o
                              ))
                  ...
                  function u(e, i) {
                    var s = i[e],
                      ...
                      d = i[e + 1],
                      u = t
                        ? s.children.filter(ee, this)
                        : s.querySelectorAll("option" + o);
                    if (u.length) {
                      var f,
                        m,
                        g = {
                      ...
                      a++, r && h({ optID: a }), (g.optID = a), l.push(g);
                ...
                buildList: function (e, t) {
                  ...
                  function l(e, t) {
                    ...
                    switch (t.type) {
                      ...
                      case "option":
                        (s = Z.li(
                          ...
                          (s.firstChild.id = i.selectId + "-" + t.index);
                        break;
                      case "optgroup-label":
                        s = Z.li(
                          Z.label.call(i, t),
                    ...
                    t.element
                      ? (t.element.innerHTML = s.innerHTML)
                      : (t.element = s),
                      e.push(t.element),
                ...
                render: function (e) {
                  ...
                  if (
                    ...
                    ((t =
                      ...
                      r > 0) &&
                      (t =
                        ((i = this.options.selectedTextFormat.split(">"))
                          .length > 1 &&
                          r > i[1]) ||
                        (1 === i.length && r >= 2)),
                    !1 === t)
                    ...
                    var I = this.$element[0].querySelectorAll(
                        "select > option" + k + ", optgroup" + k + " option" + k
                      ).length,
                      y =
                        "function" == typeof this.options.countSelectedText
                          ? this.options.countSelectedText(r, I)
                ...
                liHeight: function (t) {
                  if (
                    ...
                    if (
                      ...
                      for (
                        var v = 0;
                        v < this.selectpicker.current.data.length;
                        v++
                      ) {
                        var g = this.selectpicker.current.data[v];
                        if (
                          "option" === g.type &&
                          "none" !== e(g.element.firstChild).css("display")
                        ) {
                          i = g.element;
                          break;
                        }
                    ...
                    var w,
                      ...
                      T = {
                        vert:
                          ...
                          y(O.paddingBottom) +
                          y(O.borderTopWidth) +
                          y(O.borderBottomWidth),
                        horiz:
                          y(O.paddingLeft) +
                          y(O.paddingRight) +
                          y(O.borderLeftWidth) +
                          y(O.borderRightWidth),
                      },
                      z = {
                ...
                getSelectPosition: function () {
                  ...
                  i.options.container && o.length && !o.is("body")
                    ? (((t = o.offset()).top += parseInt(
                        o.css("borderTopWidth")
                      )),
                      (t.left += parseInt(o.css("borderLeftWidth"))))
                    : (t = { top: 0, left: 0 });
                  var l = i.options.windowPadding;
                  (this.sizeInfo.selectOffsetTop =
                    n.top - t.top - s.scrollTop()),
                ...
                setMenuSize: function (e) {
                  ...
                  if (
                    ...
                    for (var b = 0; b < this.options.size; b++)
                      "divider" === this.selectpicker.current.data[b].type &&
                        g++;
                ...
                setOptionStatus: function (e) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      s.option &&
                        (!0 !== e && t.setDisabled(s), t.setSelected(s));
                    }
                    this.options.source.data &&
                ...
                setSelected: function (e, t) {
                  ...
                  n &&
                    ...
                    l ||
                      ...
                      ((i = this.prevActiveElement), this.defocusItem(i)));
                },
                setDisabled: function (e) {
                  ...
                  s &&
                    ...
                    t &&
                      (V.major >= "4" && t.classList.toggle(G.DISABLED, i),
                      i
                ...
                clickListener: function () {
                  ...
                  i.data("spaceSelect", !1),
                            ...
                            (function () {
                              if (t.multiple) t.deselectAll();
                                ...
                                var e = t.$element[0],
                                  ...
                                  n = e.options[s],
                                  o =
                                    !!n && t.selectpicker.main.data[n.liIndex];
                                o && t.setSelected(o, !1),
                                  (e.selectedIndex = 0),
                                  (w = [s, !1, i]),
                    ...
                    this.$element.on("shown" + F, function () {
                      t.$menuInner[0].scrollTop !==
                        t.selectpicker.view.scrollTop &&
                        (t.$menuInner[0].scrollTop =
                          t.selectpicker.view.scrollTop),
                      ...
                      if (
                        ...
                        var f = r.option,
                          ...
                          k = t.selectpicker.current.data.find(function (e) {
                            return (
                              e.optID === r.optID && "optgroup-label" === e.type
                            );
                          }),
                        ...
                        if (
                          (a === t.activeElement && (s = !0),
                          s ||
                            ((t.prevActiveElement = t.activeElement),
                          ...
                          if (
                            ...
                            if ((E && S) || ($ && A))
                              if (E && 1 === E)
                                (o.selectedIndex = -1), t.setOptionStatus(!0);
                              else if ($ && 1 === $) {
                                for (O = 0; O < x.length; O++) {
                                  var T = x[O];
                                  t.setSelected(
                                    t.selectpicker.current.data[T.liIndex],
                                    !1
                                  );
                                }
                                t.setSelected(r, !0);
                                ...
                                D[2] &&
                                  ...
                                  E &&
                                    S &&
                                    (H.append(e("<div>" + L + "</div>")),
                                    (u = !1),
                                    t.$element.trigger("maxReached" + F)),
                                  $ &&
                                    A &&
                                    (H.append(e("<div>" + N + "</div>")),
                                    (u = !1),
                        ...
                        t.options.source.data &&
                          t.$element[0].appendChild(
                            t.selectpicker.main.optionQueue
                          ),
                          !t.multiple ||
                          (t.multiple && 1 === t.options.maxOptions)
                    ...
                    this.$searchbox.on("input propertychange", function () {
                      ...
                      if (
                        ...
                        if (
                          ...
                          for (
                            var a = 0;
                            a < e.selectpicker.main.data.length;
                            a++
                          ) {
                  ...
                  if (void 0 !== e) {
                    ...
                    if (
                      ...
                      if (this.multiple) this.setOptionStatus(!0);
                        ...
                        "number" == typeof l &&
                          this.setSelected(
                            this.selectpicker.current.data[l],
                            !0
                          );
                      }
                ...
                keydown: function (t) {
                  var i,
                    ...
                    c = (a ? r.closest(".dropdown") : r.closest(q.MENU)).data(
                      "this"
                    ),
                    d = c.findLis(),
                    h = !1,
                    p = t.which === W && !a && !c.options.selectOnTab,
                    u = Q.test(t.which) || p,
                    f = c.$menuInner[0].scrollTop,
                    m =
                      !0 === c.isVirtual() ? c.selectpicker.view.position0 : 0;
                    ...
                    if (
                      ...
                      if (
                        ...
                        -1 !==
                          ...
                          t.which === B
                            ...
                            : (t.which === R || p) &&
                              (++i + m >=
                                c.selectpicker.view.canHighlight.length &&
                        ...
                        t.which === B
                          ? 0 === m && i === d.length - 1
                            ...
                            : (o = c.selectpicker.current.data[v]) &&
                              (h = (l = o.position - o.height) < f)
                          : (t.which === R || p) &&
                            (i === c.selectpicker.view.firstHighlightIndex
                              ...
                              : (o = c.selectpicker.current.data[v]) &&
                                (h =
                                  (l =
                                    o.position - c.sizeInfo.menuInnerHeight) >
                                  f)),
                          (n = c.selectpicker.current.elements[v]),
                          (c.activeElement = (
                            c.selectpicker.current.data[v] || {}
                          ).element),
                          c.focusItem(n),
                        ...
                        for (
                          var k = 0;
                          k < c.selectpicker.current.data.length;
                          k++
                        ) {
                      ...
                      s &&
                        ((t.which === P &&
                          ...
                          t.which === M ||
                          (t.which === W && c.options.selectOnTab)) &&
                ...
                destroy: function () {
                  this.$newElement.before(this.$element).remove(),
                    ...
                    this.$element
                      ...
                      .removeClass(
                        "bs-select-hidden selectpicker mobile-device"
                      ),
