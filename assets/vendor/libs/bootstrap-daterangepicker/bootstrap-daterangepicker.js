                  ...
                  (function (t, e) {
                    var a = function (a, i, s) {
                      if (
                        ...
                        (this.ranges = {}),
                        (this.opens = "right"),
                        this.element.hasClass("pull-right") &&
                          (this.opens = "left"),
                        (this.drops = "down"),
                        ...
                        "string" ==
                          typeof (i = e.extend(this.element.data(), i))
                            .template ||
                        ...
                        (this.parentEl =
                          i.parentEl && e(i.parentEl).length
                            ? e(i.parentEl)
                            : e(this.parentEl)),
                        (this.container = e(i.template).appendTo(
                          this.parentEl
                        )),
                      ...
                      if (
                        ...
                        "object" == typeof i.endDate &&
                          (this.endDate = t(i.endDate)),
                        "object" == typeof i.minDate &&
                          (this.minDate = t(i.minDate)),
                        "object" == typeof i.maxDate &&
                          (this.maxDate = t(i.maxDate)),
                        this.minDate &&
                        ...
                        "object" == typeof i.dateLimit &&
                          (this.maxSpan = i.dateLimit),
                        ...
                        "boolean" == typeof i.autoApply &&
                          (this.autoApply = i.autoApply),
                      ...
                      if ("object" == typeof i.ranges) {
                        for (h in i.ranges) {
                          ...
                          if (
                            ...
                            ((m =
                              document.createElement("textarea")).innerHTML =
                              h),
                              (n = m.value),
                              (this.ranges[n] = [o, l]);
                        }
                    ...
                    return (
                      (a.prototype = {
                        ...
                        renderCalendar: function (a) {
                          ...
                          if (this.showDropdowns) {
                            ...
                            A += "</select>";
                            for (
                              var N = '<select class="yearselect">', O = S;
                              O <= M;
                              O++
                            )
                              N +=
                        ...
                        renderTimePicker: function (t) {
                          if ("right" != t || this.endDate) {
                            ...
                            if (((e += "</select> "), this.timePickerSeconds)) {
                              for (
                                e += ': <select class="secondselect">', h = 0;
                                h < 60;
                                h++
                              )
                                (p = h < 10 ? "0" + h : h),
                      ...
                      (e.fn.daterangepicker = function (t, i) {
                        var s = e.extend(
                          !0,
                          {},
                          e.fn.daterangepicker.defaultOptions,
                          t
                        );
                        return (
                          this.each(function () {
          ...
          return (
            ...
            e &&
              ...
              this.each(function () {
                ...
                t && t.container && t.container.addClass("with-week-numbers");
              }),
            this
          );
        };
