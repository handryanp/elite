              ...
              return (o.Bloodhound =
                          ...
                          return (
                            ...
                            r.each(i, function (e) {
                              ...
                              for (
                                ...
                                r = r[t][o];
                              if (!r || 0 !== i.length) return (s = []), !1;
                              (u = r[n].slice(0)), (s = s ? c(s, u) : u);
                            }),
                            s
                              ? r.map(u(s), function (t) {
                                  return a.datums[t];
                                })
                              : []
                          );
                ...
                (f = (function () {
                  ...
                  function o(t) {
                    ...
                    function o(t, e) {
                      return (
                        (e.url = e.url.replace(n, encodeURIComponent(t))), e
                      );
                    }
                    function s(t, e) {
                      return e;
