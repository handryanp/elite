  ...
  return (function () {
    ...
    e.r(r),
      e.d(r, {
        ...
        registerCursorTracker: function () {
          return s;
        },
      });
    var t,
      ...
      s = function (e) {
        ...
        return (
          (a.CLEAVE_ZEN_cursor_tracker = function (e) {
            var r,
              t = e.target;
            ("deleteContentBackward" === e.inputType ||
              t.value.length !== t.selectionEnd) &&
              ((t.CLEAVE_ZEN_cleanCursorIndex = (function (e) {
                for (
                  var r = e.value,
      ...
      N = function (e, r) {
        ...
        (e = (function (e) {
          var r = e.value,
            ...
            u = "";
          return (
            (void 0 === n ? [] : n).forEach(function (e, r) {
              if (t.length > 0) {
                var n = t.slice(0, e),
                  a = n.slice(0, 1),
                  l = t.slice(e);
              ...
              return (
                ...
                (c = (function (e) {
                  ...
                  return 0 === t.length ||
                    ...
                    (e.datePattern.filter(function (e) {
