!(function (t, e) {
  ...
  return (function () {
    ...
    function Bt(t, e, i) {
      ...
      if (t._sorted) {
        const { iScale: a, _parsed: r } = t,
          h = a.axis,
          { min: l, max: c, minDefined: d, maxDefined: u } = a.getUserBounds();
        d &&
          (n = Dt(
            Math.min(
              At(r, h, l).lo,
          ...
          (o = u
            ? Dt(
                Math.max(
                  ...
                  i ? 0 : At(e, h, a.getPixelForValue(c), !0).hi + 1
                ),
                n,
                s
              ) - n
    ...
    const Nt = (t) => 0 === t || 1 === t,
      ...
      jt = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * at) / i) + 1,
      $t = {
        linear: (t) => t,
        easeInQuad: (t) => t * t,
        easeOutQuad: (t) => -t * (t - 2),
    ...
    function Zt(t, e, i) {
      return (function (t, e) {
        ...
        let s = Gt.get(i);
        return s || ((s = new Intl.NumberFormat(t, e)), Gt.set(i, s)), s;
      })(e, i).format(t);
    }
    const Jt = {
      values(t) {
    ...
    class ne {
      constructor(t, e) {
        (this.animation = void 0),
          ...
          (this.hover = {}),
          (this.hoverBackgroundColor = (t, e) => Xt(e.backgroundColor)),
        ...
        if (((d = i[h]), null == d || V(d))) {
          if (V(d))
            for (l = 0, c = d.length; l < c; l++)
              (u = d[l]), null == u || V(u) || (a = ae(t, n, o, a, u));
        } else a = ae(t, n, o, a, d);
      t.restore();
      const f = o.length / 2;
      if (f > i.length) {
    ...
    function de(t, e, i, s, n) {
      ...
      if (!(isNaN(p) || p <= 0)) {
        switch ((t.beginPath(), f)) {
          default:
            n ? t.ellipse(i, s, n / 2, p, 0, 0, at) : t.arc(i, s, p, 0, at),
              t.closePath();
            break;
          case "triangle":
            (c = n ? n / 2 : p),
    ...
    function ye(t, e) {
      ...
      t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * ot, ot, !0),
        ...
        t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, ot, ct, !0),
        ...
        t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -ct, !0),
            ...
            (function (t, e, i) {
              ...
              st(r) &&
                ...
                (r = (function (t, e, i, s) {
                  ...
                  r.add(t);
                  let h = e(o, a || s);
                  r.delete(t), Ie(t, h) && (h = We(n._scopes, n, t, h));
                  return h;
                })(e, r, t, i));
              V(r) &&
                r.length &&
    ...
    function We(t, e, i, s) {
      ...
      return (
        null !== h &&
        (void 0 === o || o === i || ((h = Ne(r, a, o, h, s)), null !== h)) &&
        Te(Array.from(r), [""], n, o, () =>
          (function (t, e, i) {
      ...
      !(function (t, e, i) {
        ...
        (function (t, e, i = "x") {
          ...
          let o,
            ...
            h = Ue(t, 0);
          for (let l = 0; l < n; ++l) {
            if (((a = r), (r = h), (h = Ue(t, l + 1)), !r)) continue;
            const n = r[i],
              c = r[s];
            a &&
              ((o = (n - a[i]) / 3),
    ...
    function Ze(t, e, i, s, n) {
      ...
      if (
        ...
        for (o = 0, a = t.length; o < a; ++o)
          (r = t[o]),
            (h = qe(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)),
            (r.cp1x = h.previous.x),
            (r.cp1y = h.previous.y),
            (r.cp2x = h.next.x),
            (r.cp2y = h.next.y),
    ...
    function xi(t, e, i) {
      ...
      const { property: s, start: n, end: o } = i,
        ...
        { compare: r, between: h, normalize: l } = mi(s),
        {
          ...
          return (
            u < d && (u += h), { start: d, end: u, loop: f, style: t.style }
          );
        })(t, e, i),
        g = [];
      let p,
    ...
    function Mi(t, e) {
      ...
      const i = [],
        s = function (t, e) {
          return Yt(e) ? (i.includes(e) || i.push(e), i.indexOf(e)) : e;
        };
    ...
    class Wi {
      ...
      buildOrUpdateElements(t) {
        ...
        (e._stacked = Li(e.vScale, e)),
          e.stack !== i.stack && ((s = !0), Fi(e), (e.stack = i.stack)),
      ...
      parseObjectData(t, e, i, s) {
        ...
        for (l = 0, c = s; l < c; ++l)
          (d = l + i),
            (u = e[d]),
            (h[l] = { x: n.parse(tt(u, a), d), y: o.parse(tt(u, r), d) });
        return h;
      }
      getParsed(t) {
      ...
      applyStack(t, e, i) {
        const s = this.chart,
          ...
          o = e[t.axis];
        return Ti(
          { keys: Ai(s, !0), values: e._stacks[t.axis]._visualValues },
          o,
          n.index,
          { mode: i }
        );
      ...
      updateRangeFromParsed(t, e, i, s) {
        ...
        s && a && ((s.values = a), (o = Ti(s, n, this._cachedMeta.index))),
      ...
      getMinMax(t, e) {
        const i = this._cachedMeta,
          ...
          r = ((t, e, i) =>
            t && !e.hidden && e._stacked && { keys: Ai(i, !0), values: null })(
            e,
            i,
            this.chart
          ),
      ...
      _resolveElementOptions(t, e = "default", i) {
        ...
        return (
          f.$shared && ((f.$shared = r), (n[o] = Object.freeze(Bi(f, r)))), f
        );
      }
          ...
          { circumference: d, rotation: u } = this._getRotationExtents(),
          {
            ...
            if (e < at) {
              const r = t,
                ...
                u = Math.sin(h),
                f = (t, e, s) =>
                  Pt(t, r, h, !0) ? 1 : Math.max(e, e * i, s, s * i),
                g = (t, e, s) =>
                  Pt(t, r, h, !0) ? -1 : Math.min(e, e * i, s, s * i),
                p = f(0, l, d),
                m = f(ct, c, u),
                b = g(ot, l, d),
                x = g(ot + ct, c, u);
          ...
          for (let u = e; u < e + i; u++) {
            const e = this.getParsed(u),
              ...
              p = {
                ...
                base: i.base,
                enableBorderRadius:
                  !g || $i(e._custom) || o === g._top || o === g._bottom,
                x: h ? i.head : f.center,
                y: h ? f.center : i.head,
          ...
          for (let l = e; l < e + i; ++l) {
            const e = t[l],
              ...
              v = (g[f] =
                n || _
                  ? a.getBasePixel()
                  : a.getPixelForValue(r ? this.applyStack(a, i, r) : i[f], l));
            (g.skip = isNaN(y) || isNaN(v) || _),
              ...
              d &&
                (g.options =
                  c ||
                  this.resolveDataElementOptions(l, e.active ? "active" : s)),
      ...
      modes: {
        index(t, e, i, s) {
          const n = ni(e, t),
            ...
            r = i.intersect ? ss(t, n, o, s, a) : os(t, n, o, !1, s, a),
            h = [];
          return r.length
        ...
        dataset(t, e, i, s) {
          const n = ni(e, t),
            o = i.axis || "xy",
            a = i.includeInvisible || !1;
          let r = i.intersect ? ss(t, n, o, s, a) : os(t, n, o, !1, s, a);
          if (r.length > 0) {
        ...
        point(t, e, i, s) {
          return ss(t, ni(e, t), i.axis || "xy", s, i.includeInvisible || !1);
        },
        nearest(t, e, i, s) {
          const n = ni(e, t),
            o = i.axis || "xy",
    ...
    function cs(t, e) {
      return t.filter((t) => -1 === hs.indexOf(t.pos) && t.box.axis === e);
    }
    function ds(t, e) {
      return t.sort((t, i) => {
        const s = e ? i : t,
    ...
    function bs(t, e, i, s) {
      ...
      for (o = 0, a = t.length, l = 0; o < a; ++o) {
        (r = t[o]),
          (h = r.box),
          h.update(r.width || e.w, r.height || e.h, ms(r.horizontal, e));
      ...
      for (const r of t) {
        ...
        if (r.horizontal) {
          ...
          it(h.start) && (a = h.start),
            t.fullSize
              ? xs(t, n.left, a, i.outerWidth - n.right - n.left, o)
          ...
          it(h.start) && (o = h.start),
            t.fullSize
              ? xs(t, o, n.top, a, i.outerHeight - n.bottom - n.top)
    ...
    function Rs(t, e, i) {
      ...
      return (
        a.observe(n),
        (function (t, e) {
          Ts.size || window.addEventListener("resize", Es), Ts.set(t, e);
        })(t, o),
        a
      );
    }
    function Is(t, e, i) {
      i && i.disconnect(),
        "resize" === e &&
          (function (t) {
            Ts.delete(t), Ts.size || window.removeEventListener("resize", Es);
          })(t);
    }
    function zs(t, e, i) {
      const s = t.canvas,
    ...
    function Bs(t, e) {
      ...
      if (a > 0) {
        ...
        for (Ws(e, l, c, F(s) ? 0 : r - s, r), t = 0, i = a - 1; t < i; t++)
          Ws(e, l, c, o[t], o[t + 1]);
    ...
    const Ns = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i),
      ...
      calculateLabelRotation() {
        ...
        (o = t.offset ? this.maxWidth / i : u / (i - 1)),
          c + 6 > o &&
            ...
            (h = yt(
              Math.min(
                Math.asin(Dt((l.highest.height + 6) / o, -1, 1)),
                Math.asin(Dt(a / r, -1, 1)) - Math.asin(Dt(d / r, -1, 1))
              )
            )),
        ...
        for (h = 0; h < e; h += r) {
          if (
            ...
            if (V(d))
              for (l = 0, c = d.length; l < c; ++l)
                (x = d[l]),
                  F(x) || V(x) || ((m = ae(s, g.data, g.gc, m, x)), (b += p));
        ...
        const {
          ...
          if (t.isHorizontal()) {
            if (((u = Vt(s, o, r)), B(i))) {
              ...
              f = "center" === i ? (l.bottom + l.top) / 2 + p - e : Ns(t, i, e);
            d = r - o;
          } else {
            if (B(i)) {
              const t = Object.keys(i)[0],
              ...
              u = "center" === i ? (l.left + l.right) / 2 - m + e : Ns(t, i, e);
    ...
    class Ks {
      ...
      unregister(t) {
        const e = this.items,
          ...
          s = this.scope;
        i in e && delete e[i],
          s && i in oe[s] && (delete oe[s][i], this.override && delete te[i]);
      }
    }
    class Gs {
      constructor() {
          ...
          ? (function (t, { plugins: e, localIds: i }, s, n) {
              ...
              for (const r of e) {
                ...
                null !== h &&
                  o.push({
                    plugin: r,
                    options: tn(t.config, { plugin: r, local: i[e] }, h, a),
                  });
              }
              return o;
            })(t, n, s, e)
          ...
          const r = nn(
              ...
              (function (t, e) {
                if (e.data && e.data.datasets) {
                  ...
                  if (i.length) return on(t, "x", i[0]) || on(t, "y", i[0]);
                }
                return {};
              })(e, t),
              oe.scales[a.type]
    ...
    class fn {
      ...
      chartOptionScopes() {
        ...
        return [t, te[e] || {}, oe.datasets[e] || {}, { type: e }, oe, ee];
      }
      resolveNamedOptions(t, e, i, s = [""]) {
        const n = { $shared: !0 },
          { resolver: o, subPrefixes: a } = gn(this._resolverCache, t, s);
        let r = o;
        if (
          (function (t, e) {
            ...
            for (const n of e) {
              const e = i(n),
                o = s(n),
                a = (o || e) && t[n];
              if ((e && (st(a) || pn(a))) || (o && V(a))) return !0;
            }
            return !1;
          })(o, e)
        ) {
          n.$shared = !1;
          r = Le(o, (i = st(i) ? i() : i), this.createResolver(t, i, a));
        }
    ...
    class Pn {
        ...
        e &&
          ...
          Y(n, (e) => {
            const n = e.options,
              ...
              a = nn(o, n),
              r = H(n.type, e.dtype);
            (void 0 !== n.position && bn(n.position, a) === bn(e.dposition)) ||
        ...
        for (
          ...
          if (
            ...
            const e = Zs.getController(o),
              { datasetElementType: s, dataElementType: a } = oe.datasets[o];
            Object.assign(e, {
      ...
      _stop() {
        let t, e;
        for (
          this.stop(), ki.remove(this), t = 0, e = this.data.datasets.length;
          t < e;
          ++t
        )
    ...
    function Tn(t, e, i, s, n) {
      const { fullCircles: o, startAngle: a, circumference: r, options: h } = e,
        {
          borderWidth: l,
          borderJoinStyle: c,
          borderDash: d,
      ...
      for (d = 0; d <= l; ++d)
        (u = n[(r + (p ? l - d : d)) % a]),
          u.skip ||
            ...
            (f = u));
      return (
        h && ((u = n[(r + (p ? l : 0)) % a]), c(t, f, u, p, o.stepped)), !!h
      );
    }
    function zn(t, e, i, s) {
      const n = e.points,
      ...
      const e = Hn(t),
        ...
        o = (function (t, e, i) {
          ...
          return {
            ...
            bottomLeft: jn(!h || r.bottom || r.left, o.bottomLeft, 0, a),
            bottomRight: jn(!h || r.bottom || r.right, o.bottomRight, 0, a),
          };
        })(t, i / 2, s / 2);
      return {
    ...
    function Yn(t, e, i, s) {
      const n = null === e,
        ...
        a = t && !(n && o) && Hn(t, s);
      return (
        a && (n || Ot(e, a.left, a.right)) && (o || Ot(i, a.top, a.bottom))
      );
    }
    function Un(t, e) {
    ...
    const Kn = [
      ...
      Gn = Kn.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
    function Zn(t) {
    ...
    function Qn(t) {
      ...
      return (i, s) => {
        ...
        n instanceof Ki
          ? (e = (function (t, e) {
              return (t.backgroundColor = t.data.map(() => Zn(e++))), e;
            })(i, e))
          : n instanceof Gi
          ? (e = (function (t, e) {
          ...
          : n &&
            (e = (function (t, e) {
              return (t.borderColor = Zn(e)), (t.backgroundColor = Jn(e)), ++e;
            })(i, e));
      };
    }
    function to(t) {
        ...
        t.data.datasets.forEach((e, n) => {
          ...
          let { start: c, count: d } = (function (t, e) {
            ...
            return (
              ...
              (s = l ? Dt(At(e, o.axis, r).hi + 1, n, i) - n : i - n),
              { start: n, count: s }
            );
          })(r, h);
        ...
        (function (t, e) {
          ...
          t.save(),
            "x" === h &&
              o !== n &&
              (xo(t, s, a.top),
              _o(t, { line: i, target: s, color: n, scale: r, property: h }),
              t.restore(),
              t.save(),
              xo(t, s, a.bottom));
          _o(t, { line: i, target: s, color: o, scale: r, property: h }),
            t.restore();
        })(t, {
          line: n,
          target: s,
    ...
    function _o(t, e) {
      ...
      for (const { source: e, target: h, start: l, end: c } of r) {
        const { style: { backgroundColor: r = o } = {} } = e,
          d = !0 !== s;
        t.save(), (t.fillStyle = r), yo(t, a, d && oo(n, l, c)), t.beginPath();
      ...
      afterDatasetsUpdate(t, e, i) {
        ...
        for (a = 0; a < s; ++a)
          (o = t.getDatasetMeta(a)),
            ...
            n.push(h);
        for (a = 0; a < s; ++a)
          (h = n[a]), h && !1 !== h.fill && (h.fill = co(n, a, i.propagate));
      },
      beforeDraw(t, e, i) {
    ...
    class ko extends Vs {
      ...
      adjustHitBoxes() {
        ...
        if (this.isHorizontal()) {
          let n = 0,
            a = Vt(i, this.left + s, this.right - this.lineWidths[n]);
          for (const r of e)
            n !== r.row &&
              ((n = r.row),
              (a = Vt(i, this.left + s, this.right - this.lineWidths[n]))),
          ...
          r.setWidth(this.width),
            m
              ? y > 0 &&
                ...
                ((S = u.y += x),
                u.line++,
                (k = u.x = Vt(n, this.left + l, this.right - i[u.line])))
              : y > 0 &&
                S + x > this.bottom &&
                ((k = u.x = k + e[u.line].width + l),
                u.line++,
                (S = u.y =
                  Vt(n, this.top + b + l, this.bottom - e[u.line].height)));
          if (
            ((function (t, e, i) {
      ...
      _getLegendItemAt(t, e) {
        ...
        if (Ot(t, this.left, this.right) && Ot(e, this.top, this.bottom))
          for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
            if (
              ((s = n[i]),
              Ot(t, s.left, s.left + s.width) && Ot(e, s.top, s.top + s.height))
            )
    ...
    var Po = {
      ...
      _element: ko,
      start(t, e, i) {
        const s = (t.legend = new ko({ ctx: t.ctx, options: i, chart: t }));
      ...
      _drawArgs(t) {
        ...
        return (
          this.isHorizontal()
            ...
            : ("left" === o.position
                ? ((h = i + t), (l = Vt(a, s, e)), (c = -0.5 * ot))
                : ((h = n - t), (l = Vt(a, e, s)), (c = 0.5 * ot)),
              (r = s - e)),
    ...
    function Io(t, e) {
      ...
      if (
        ...
        d &&
          (p +=
            d * l.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom),
        b)
      ) {
        p +=
    ...
    function Vo(t, e, i, s) {
      const { caretSize: n, caretPadding: o, cornerRadius: a } = t,
        { xAlign: r, yAlign: h } = i,
        l = n + o,
        { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = Pe(a);
      let g = (function (t, e) {
        let { x: i, width: s } = t;
      ...
      return (
        ...
        { x: Dt(g, 0, s.width - e.width), y: Dt(p, 0, s.height - e.height) }
      );
    }
    function Bo(t, e, i) {
    ...
    class $o extends Vs {
      ...
      getContext() {
        return (
          ...
          (this.$context =
            ...
            Ae(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
        );
        var t, e, i;
      }
      getTitle(t, e) {
      ...
      _createItems(t) {
        ...
        let a,
          r,
          h = [];
        for (a = 0, r = e.length; a < r; ++a) h.push(Ro(this.chart, e[a]));
        return (
      ...
      getCaretPosition(t, e, i) {
        const { xAlign: s, yAlign: n } = this,
          ...
          { topLeft: r, topRight: h, bottomLeft: l, bottomRight: c } = Pe(a),
          { x: d, y: u } = t,
          { width: f, height: g } = e;
        let p, m, b, x, _, y;
        return (
        ...
        if (n.usePointStyle) {
          ...
          Object.values(a).some((t) => 0 !== t)
            ? (t.beginPath(),
              ...
              (t.fillStyle = o.backgroundColor),
              t.beginPath(),
              ye(t, { x: i, y: f + 1, w: h - 2, h: r - 2, radius: a }),
              t.fill())
            : ((t.fillStyle = n.multiKeyBackground),
              t.fillRect(e, f, h, r),
      ...
      drawBody(t, e, i) {
        ...
        for (
          e.textAlign = o,
            ...
            Y(this.beforeBody, g),
            u =
              a && "right" !== p ? ("center" === o ? h / 2 + l : h + 2 + l) : 0,
            _ = 0,
            v = s.length;
          _ < v;
          ++_
    ...
    function Ko(t, e) {
      ...
      (w = Math.ceil(p / k) - Math.floor(g / k)),
        ...
        (function (t, e) {
          ...
          ? ((w = Math.round(Math.min((a - o) / k, l))),
            ...
            (M = a))
          : x
          ? ((v = m ? o : v), (M = b ? a : M), (w = h - 1), (k = (M - v) / w))
          : ((w = (M - v) / k),
            (w = pt(w, Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w)));
      ...
      for (
        ...
        (d && v !== o
          ? (i.push({ value: o }),
            v < o && P++,
            pt(Math.round((v + P * k) * y) / y, o, Go(o, _, t)) && P++)
          : v < o && P++);
        P < w;
        ++P
      ) {
    ...
    class na extends qs {
      ...
      static defaults = {
        ticks: { callback: Qt.formatters.logarithmic, major: { enabled: !0 } },
      };
      constructor(t) {
        super(t),
          (this.start = void 0),
      ...
      determineDataLimits() {
        ...
        (this.min = W(t) ? Math.max(0, t) : null),
          ...
          this._zero &&
            ...
            !W(this._userMin) &&
            (this.min =
              t === ta(this.min, 0) ? ta(this.min, -1) : ta(this.min, 0)),
          this.handleTickRangeOptions();
      }
      handleTickRangeOptions() {
        ...
        const n = (e) => (i = t ? i : e),
          o = (t) => (s = e ? s : t);
        i === s && (i <= 0 ? (n(1), o(10)) : (n(ta(i, -1)), o(ta(s, 1)))),
          i <= 0 && n(ta(s, -1)),
          s <= 0 && o(ta(i, 1)),
          (this.min = i),
          (this.max = s);
        ...
        return (
          ...
          null === t || isNaN(t)
            ...
            : this.getPixelForDecimal(
                t === this.min
                  ? 0
                  : (ft(t) - this._startValue) / this._valueRange
              )
        );
      }
      getValueForPixel(t) {
      ...
      t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
        (t._pointLabelItems = (function (t, e, i) {
          const s = [],
            ...
            h = { extra: oa(o) / 2, additionalAngle: a ? ot / n : 0 };
          let l;
          for (let o = 0; o < n; o++) {
            (h.padding = i[o]), (h.size = e[o]);
            const n = la(t, o, h);
            s.push(n),
              "auto" === r && ((n.visible = ca(n, l)), n.visible && (l = n));
          }
          return s;
        })(t, s, n));
    }
    ...
    class fa extends Zo {
      ...
      static defaults = {
        ...
        grid: { circular: !1 },
        startAngle: 0,
        ticks: { showLabelBackdrop: !0, callback: Qt.formatters.numeric },
        pointLabels: {
      ...
      getPointLabelContext(t) {
        ...
        if (t >= 0 && t < e.length) {
          ...
          return (function (t, e, i) {
            return Ae(t, { label: i, index: e, type: "pointLabel" });
          })(this.getContext(), t, i);
        }
      }
          ...
          (e.pointLabels.display &&
            (function (t, e) {
              ...
              for (let n = e - 1; n >= 0; n--) {
                ...
                _e(i, t._pointLabels[n], r, h + a.lineHeight / 2, a, {
                  color: o.color,
                  textAlign: l,
                  textBaseline: "middle",
                });
    ...
    function xa(t, e, i, s) {
      ...
      for (let o = pa.indexOf(t); o < n - 1; ++o) {
        ...
        if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return pa[o];
      }
      return pa[n - 1];
    }
    function _a(t, e, i) {
    ...
    class va extends qs {
      ...
      buildTicks() {
        ...
        return (
          (this._unit =
            e.unit ||
            (i.autoSkip
              ? xa(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
              : (function (t, e, i, s, n) {
                  for (let o = pa.length - 1; o >= pa.indexOf(i); o--) {
                    const i = pa[o];
                    if (ga[i].common && t._adapter.diff(n, s, i) >= e - 1)
                      return i;
                  }
          ...
          (this._majorUnit =
            i.major.enabled && "year" !== this._unit
              ? (function (t) {
                  for (let e = pa.indexOf(t) + 1, i = pa.length; e < i; ++e)
      ...
      _generate() {
        const t = this._adapter,
          ...
          s = this.options,
          n = s.time,
          o = n.unit || xa(n.minUnit, e, i, this._getLabelCapacity(e)),
      ...
      _getLabelCapacity(t) {
        const e = this.options.time,
          ...
          n = this._tickFormatFunction(t, 0, ya(this, [t], this._majorUnit), s),
