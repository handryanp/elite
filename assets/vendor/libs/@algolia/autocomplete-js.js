!(function (e, t) {
  ...
  return (function () {
    ...
    function i(e, t) {
      if (e === t) return !0;
      if (o(e) || o(t) || "function" == typeof e || "function" == typeof t)
        return e === t;
    ...
    var D = "2.15.0",
      C = "https://cdn.jsdelivr.net/npm/search-insights@".concat(
        D,
        ...
        d = r(function (e) {
          ...
          if (t.isOpen) {
            ...
            i(
              ...
              ((y.current = r),
              r.length > 0 &&
                k({ onItemsChange: l, items: r, insights: v, state: t }));
          }
        }, 0);
      return {
          ...
          function o(e) {
            t({
              algoliaInsightsPlugin: {
                __algoliaSearchParameters: E(
                  E({}, p ? { clickAnalytics: !0 } : {}),
                  e ? { userToken: T(e) } : {}
                ),
                insights: v,
              },
                ...
                s({
                  ...
                  insightsEvents: [
                    E(
                      ...
                      a({ item: t, items: o.getItems().filter(S) })
                    ),
                  ],
                });
            }),
                ...
                f({
                  ...
                  insightsEvents: [
                    E(
                      ...
                      a({ item: t, items: r.getItems().filter(S) })
                    ),
                  ],
                });
            });
    ...
    function N() {
      ...
      return [].concat(
        ...
        P(
          null !== (e = t.algoliaInsightsPlugin) &&
            void 0 !== e &&
            e.__automaticInsights
    ...
    function L(e, t, r) {
      ...
      return {
        ...
        dispatch: function (n, i) {
          ...
          (o = e(o, { type: n, props: t, payload: i })),
            r({ state: o, prevState: u });
        },
        pendingRequests:
          ((n = []),
          {
                ...
                [{}].concat(
                  pe(
                    Object.keys(r.context).map(function (e) {
                      var t;
                      return null === (t = r.context[e]) || void 0 === t
                        ? void 0
          ...
          {},
          {
            requests: e.queries.map(function (r) {
              return {
                query:
                  "algolia" === e.requesterId
                    ? se(se({}, r), {}, { params: se(se({}, n), r.params) })
                    : r,
                sourceId: t,
      ...
      return t.map(function (t) {
        var n,
          ...
          a = u
            ...
            : i;
        return (
          t.onResolve({ source: t, results: i, items: a, state: r.getState() }),
          Array.isArray(a),
          a.every(Boolean),
    ...
    function Te(e) {
      ...
      var g = Oe(
        Ne(
          o
            .getSources(Ie({ query: i, refresh: u, state: a.getState() }, c))
            .then(function (e) {
              return Promise.all(
                e.map(function (e) {
                  return Promise.resolve(
                    e.getItems(
                      Ie({ query: i, refresh: u, state: a.getState() }, c)
                    )
                  ).then(function (t) {
                  ...
                  var r,
                    n = t.some(function (e) {
                      return (function (e) {
                        return (
                          !Array.isArray(e) &&
                          Boolean(null == e ? void 0 : e._automaticInsights)
                        );
                      })(e.items);
                    });
                  n &&
                    v({
                      algoliaInsightsPlugin: Ie(
                        Ie(
                          {},
                          (null === (r = a.getState().context) || void 0 === r
                            ? void 0
                            : r.algoliaInsightsPlugin) || {}
                        ),
                        {},
    ...
    function Be(e, t, r) {
      return [e, null == r ? void 0 : r.sourceId, t]
        .filter(Boolean)
        .join("-")
        .replace(/\s/g, "");
    }
          ...
          return Ye(
            {
              ...
              onSubmit: function (i) {
                ...
                i.preventDefault(),
                  t.onSubmit(
                    Ye({ event: i, refresh: r, state: n.getState() }, o)
                  ),
          ...
          return Ye(
            {
              ...
              "aria-activedescendant":
                n.getState().isOpen && null !== n.getState().activeItemId
                  ? Be(
                      t.id,
                      "item-".concat(n.getState().activeItemId),
                      null == p ? void 0 : p.source
                    )
                  : void 0,
              "aria-controls": n.getState().isOpen
                ? n
          ...
          return Ye(
            {
              ...
              role: "option",
              "aria-selected":
                n.getState().activeItemId === i.__autocomplete_id,
    ...
    var rt = "1.17.8",
      nt = [{ segment: "autocomplete-core", version: rt }];
    function ot(e) {
      return (
        (ot =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    function ct(e) {
      var t,
        ...
        a =
          null ===
            (t = ((null === (r = u.__autocomplete_metadata) || void 0 === r
              ? void 0
        ...
        c = a
          ? at(
              ...
              a,
              Object.keys(
                (null === (n = u.__autocomplete_metadata) || void 0 === n
                  ? void 0
                  : n.options) || {}
              )
            )
    ...
    function lt(e) {
      ...
      return !1 === r.isOpen || null === r.activeItemId
        ? null
        : (null === (t = Se(r)) || void 0 === t ? void 0 : t.itemInputValue) ||
            null;
    }
    function st(e, t, r, n) {
      if (!r) return null;
      ...
      switch (t.type) {
        ...
        case "blur":
          return t.props.debug
            ? e
            : mt(mt({}, e), {}, { isOpen: !1, activeItemId: null });
        case "mouseleave":
          return mt(
            mt({}, e),
            {},
    ...
    function Ot(e) {
      var t = [],
        ...
        n = L(yt, r, function (e) {
          ...
          if (
            (r.onStateChange(
              gt(
                { prevState: i, state: l, refresh: u, navigator: r.navigator },
                o
              )
            ),
            !c() &&
              null !== (t = l.context) &&
              void 0 !== t &&
              null !== (n = t.algoliaInsightsPlugin) &&
              void 0 !== n &&
              n.__automaticInsights &&
              !1 !== r.insights)
          ) {
        ...
        i = tt(
          gt({ props: r, refresh: u, store: n, navigator: r.navigator }, o)
        );
      function u() {
        return Te(
          gt(
      ...
      return (
        ...
        (function (e) {
          ...
          metadata: ct({ plugins: r.plugins, options: e }),
      ...
      if ("style" === t)
        ...
        "o" === t[0] && "n" === t[1]
          ? ((n = t !== (t = t.replace(/Capture$/, ""))),
            ...
            (e._listeners[t] = r),
            r
              ? i || e.addEventListener(t, Dt, n)
              : e.removeEventListener(t, Dt, n))
          : "list" !== t &&
            "tagName" !== t &&
            "form" !== t &&
            "type" !== t &&
    ...
    var Qt = function (e) {
      var t = e.autocompleteScopeApi,
        ...
        c = Lt(r)("input", a),
        l = n(
          Ht({ state: u, props: o({ inputElement: c }), inputElement: c }, t)
        );
      return (
        xt(
          c,
    ...
    function pr(e, t, r) {
      var n,
        ...
        u = {};
      for (i in t)
        "key" == i ? (n = t[i]) : "ref" == i ? (o = t[i]) : (u[i] = t[i]);
      if (
        (arguments.length > 2 &&
          (u.children = arguments.length > 3 ? Jt.call(arguments, 2) : r),
    ...
    function gr(e) {
      ((!e.__d && (e.__d = !0) && Zt.push(e) && !hr.__r++) ||
        er !== Xt.debounceRendering) &&
    ...
    function Or(e, t, r, n, o, i, u, a, c, l, s) {
      ...
      for (r.__d = c, _r(r, t, d), c = r.__d, f = 0; f < b; f++)
        null != (m = r.__k[f]) &&
          ((p = -1 === m.__i ? ur : d[m.__i] || ur),
          (m.__i = f),
          Er(e, m, p, o, i, u, a, c, l, s),
          (v = m.__e),
          m.ref &&
            p.ref != m.ref &&
            (p.ref && Cr(p.ref, null, m), s.push(m.ref, m.__c || v, m)),
          null == y && null != v && (y = v),
    ...
    function _r(e, t, r) {
      ...
      for (e.__k = [], n = 0; n < c; n++)
        null != (o = t[n]) && "boolean" != typeof o && "function" != typeof o
          ? ((u = n + f),
            ...
            (o.__b = e.__b + 1),
            (i = null),
            -1 !== (a = o.__i = jr(o, r, u, s)) &&
              (s--, (i = r[a]) && (i.__u |= 131072)),
            null == i || null === i.__v
              ? (-1 == a && f--,
      ...
      if (s)
        for (n = 0; n < l; n++)
          null != (i = r[n]) &&
            !(131072 & i.__u) &&
            (i.__e == e.__d && (e.__d = dr(i)), kr(i, i));
    }
    function Sr(e, t, r) {
      var n, o;
      if ("function" == typeof e.type) {
        for (n = e.__k, o = 0; n && o < n.length; o++)
          n[o] && ((n[o].__ = e), (t = Sr(n[o], t, r)));
        return t;
      }
      e.__e != t &&
        (t && e.type && !r.contains(t) && (t = dr(e)),
    ...
    function jr(e, t, r, n) {
      var o = e.key,
        ...
        a = r + 1,
        c = t[r];
      if (null === c || (c && o == c.key && i === c.type && !(131072 & c.__u)))
        return r;
      if (n > (null == c || 131072 & c.__u ? 0 : 1))
        for (; u >= 0 || a < t.length; ) {
          if (u >= 0) {
            if ((c = t[u]) && !(131072 & c.__u) && o == c.key && i === c.type)
              return u;
            u--;
          }
          if (a < t.length) {
    ...
    function Pr(e, t, r) {
      "-" === t[0]
        ...
        : (e[t] =
            null == r ? "" : "number" != typeof r || cr.test(t) ? r : r + "px");
    }
      ...
      e: if ("style" === t)
        ...
        (i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1"))),
          ...
          r
            ? n
              ? (r.u = n.u)
              : ((r.u = nr), e.addEventListener(t, i ? ir : or, i))
    ...
    function Er(e, t, r, n, o, i, u, a, c, l) {
      ...
      e: if ("function" == typeof I)
        try {
          if (
            ...
            g &&
              ...
              (f.__s == f.state && (f.__s = sr({}, f.__s)),
              sr(f.__s, I.getDerivedStateFromProps(b, f.__s))),
            (m = f.props),
            (v = f.state),
            (f.__v = t),
            p)
            ...
            if (
              ...
              for (
                t.__v !== r.__v &&
                  ((f.props = b), (f.state = f.__s), (f.__d = !1)),
                  t.__e = r.__e,
                  t.__k = r.__k,
        ...
        null == i && t.__v === r.__v
          ...
          : (t.__e = Dr(r.__e, t, r, n, o, i, u, c, l));
      (s = Xt.diffed) && s(t);
    }
    function Ar(e, t, r) {
      t.__d = void 0;
    ...
    function Dr(e, t, r, n, o, i, u, a, c) {
      ...
      if (null == e) {
        ...
        (e = document.createElementNS(o, g, b.is && b)),
          a && (Xt.__m && Xt.__m(t, i), (a = !1)),
          (i = null);
      }
    ...
    function kr(e, t, r) {
      ...
      if ((n = e.__k))
        for (o = 0; o < n.length; o++)
          n[o] && kr(n[o], t, r || "function" != typeof e.type);
              ...
              try {
                if (
                  ...
                  null != o.componentDidCatch &&
                    (o.componentDidCatch(e, n || {}), (u = o.__d)),
                  u)
                )
                  return (o.__E = o);
              } catch (t) {
    ...
    function Ur(e) {
      ...
      return (
        "string" != typeof o && (o = Tr(t, n) || ""),
        Rr({ highlightedValue: o })
      );
    }
    function Mr(e) {
    ...
    function on(e, t) {
      if ("string" == typeof t) {
        ...
        return (
          "The element ".concat(JSON.stringify(t), " is not in the document."),
          r
        );
      }
      return t;
    ...
    function Un(e) {
      var t,
        ...
        y = l(function () {
          return v.value.core.environment.matchMedia(
              ...
              {},
              {
                ...
                shouldPanelOpen:
                  ...
                  function (e) {
                    ...
                    var n = Boolean(
                      f.current || v.value.renderer.renderNoResults
                    );
                    return (!r && n) || r;
                  },
        ...
        _ = l(function () {
          return (function (e) {
            var t = e.autocomplete,
              ...
              p = Lt(o),
              m = c.getRootProps(
                zt({ state: s, props: t.getRootProps({}) }, r)
              ),
              ...
              b = c.getLabelProps(
                zt({ state: s, props: t.getLabelProps({}) }, r)
              ),
              g = p("button", {
              ...
              I = c.getFormProps(
                zt({ state: s, props: t.getFormProps({ inputElement: S }) }, r)
              ),
              E = p("form", zt({ class: n.form, children: [j, w, P] }, I)),
              A = c.getPanelProps(
                zt({ state: s, props: t.getPanelProps({}) }, r)
              ),
      ...
      function j(e) {
        ...
        var t = {
            ...
            html: O.value,
            dom: _.value,
            panelContainer: y.value
              ? _.value.detachedContainer
          ...
          r =
            (!W(e) && !f.current && v.value.renderer.renderNoResults) ||
        ...
        !(function (e) {
          ...
          Nt(
            n.root,
            o.getRootProps(On({ state: i, props: t.getRootProps({}) }, r))
          ),
            Nt(
              n.input,
              o.getInputProps(
          ...
          (function (e, t) {
            ...
            if (l.isOpen) {
                            ...
                            a.map(function (e) {
                              ...
                              return f.createElement(
                                ...
                                gn(
                                  ...
                                  c.getItemProps(On({ state: l, props: t }, n))
                                ),
                                u.templates.item({
                                  components: s,
                                  createElement: f.createElement,
              ...
              e(
                On(
                  On({ children: m, state: l, sections: p, elements: v }, f),
                  {},
                  { components: s, html: i },
                  n
                ),
      ...
      function w(e) {
        e !==
          v.value.core.environment.document.body.contains(
            _.value.detachedOverlay
          ) &&
          (e
      ...
      return (
        ...
        i(function () {
          ...
          return (
            y.value && b.current.isOpen && w(!0),
            j(b.current),
            function () {
              e.contains(t) &&
                (e.removeChild(t), e.classList.remove("aa-Detached"));
            }
          );
        }),
        i(function () {
        ...
        i(function () {
          var e = r(function () {
            var e = y.value;
            (y.value = v.value.core.environment.matchMedia(
              v.value.renderer.detachedMediaQuery
            ).matches),
        ...
        i(function () {
          ...
          function e(e) {
            _.value.detachedContainer.classList.toggle(
