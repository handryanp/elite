          ...
          (n = [
            {
              ...
              value: function () {
                ...
                (this._evntElClick = function (n) {
                  if (
                    n.target.closest("ul") &&
                    n.target.closest("ul").classList.contains("menu-inner")
                  ) {
                  ...
                  this._horizontal &&
                    ...
                    (this._evntBodyClick = function (e) {
                      !t._inner.contains(e.target) &&
                        t._el.querySelectorAll(".menu-inner > .menu-item.open")
                          .length &&
                        t.closeAll();
                    }),
                    ...
                    this._showDropdownOnHover &&
                      ((this._evntElMouseOver = function (e) {
                        if (
                          ...
                          var n = e.target.classList.contains("menu-toggle")
                            ? e.target
                            : null;
                          n &&
                            (e.preventDefault(),
                            "true" !== n.getAttribute("data-hover") &&
                              t.toggle(n));
                        }
                        e.stopPropagation();
                      }),
                      ...
                      (this._evntElMouseOut = function (n) {
                        ...
                        if (
                          (o.closest("ul") &&
                            o.closest("ul").classList.contains("menu-inner") &&
                            (t._topParent = o),
                          o !== i &&
                            (o.parentNode.classList.contains("open") ||
                              !o.classList.contains("menu-toggle")) &&
                            r &&
                            r.parentNode &&
                            !r.parentNode.classList.contains("menu-link"))
                        ) {
                          if (
                            t._topParent &&
                            !e.childOf(r, t._topParent.parentNode)
                          ) {
                            var s = t._topParent.classList.contains(
                              "menu-toggle"
                            )
                              ? t._topParent
                              : null;
                            s &&
                              (n.preventDefault(),
                              "true" !== s.getAttribute("data-hover") &&
                                (t.toggle(s), (t._topParent = null)));
                          }
                          if (e.childOf(r, o.parentNode)) return;
                          var l = o.classList.contains("menu-toggle")
                            ? o
                            : null;
                          l &&
                            (n.preventDefault(),
                            "true" !== l.getAttribute("data-hover") &&
                              t.toggle(l));
                        }
                        n.stopPropagation();
                      }),
                    ...
                    .then(function () {
                      if (n._horizontal && e._isRoot(r))
                        ...
                        if ((r.classList.remove("open"), i))
                          for (
                            var t = r.querySelectorAll(".menu-item.open"),
                              o = 0,
                              l = t.length;
                            o < l;
                            o++
            ...
            },
            {
              ...
              value: function (t, n) {
                for (
                  var i = e._findChild(t.parentNode, ["menu-item", "open"]),
                    o = 0,
                    r = i.length;
                  o < r;
                  o++
              ...
              value: function (t, n, i) {
                ...
                if (t) {
                  ...
                  u - 5 <= -1 * a
                    ...
                    : u + a + c + 5 >= l &&
                      (this._innerPosition = c > l ? -1 * u : -1 * (u + c - l)),
                  ...
                  s
                    ...
                    : u + this._innerPosition + d > l &&
                      d < l &&
                      d > c &&
                      (o.style[this._rtl ? "marginRight" : "marginLeft"] =
                        "-".concat(d - c, "px")),
                  ...
                  if (
                    ...
                    for (
                      var m = o.querySelectorAll(".menu-item.open"),
                        _ = 0,
                        v = m.length;
                      _ < v;
                      _++
              ...
              value: function (t, n) {
                for (var i = [], o = null; t; )
                  t.classList.contains("disabled")
                    ? ((o = null), (i = []))
                    : (t.classList.contains("open") || (o = t), i.push(t)),
                    (t = e._findParent(t, "menu-item", !1));
                if (!o) return null;
                if (1 === i.length) return o;
                for (
                  var r = 0, s = (i = i.slice(0, i.indexOf(o))).length;
                  r < s;
                  r++
                )
                  if ((i[r].classList.add("open"), this._accordion))
                    for (
                      ...
                      if (l[a] !== i[r] && (l[a].classList.remove("open"), n))
                        for (
                          var c = l[a].querySelectorAll(".menu-item.open"),
                            d = 0,
                            h = c.length;
                          d < h;
                          d++
                  ...
                  ? ((n.style.height = "".concat(l, "px")),
                    ...
                    setTimeout(function () {
                      n.style.height = "".concat(
                        l + Math.round(s.getBoundingClientRect().height),
                        "px"
                      );
                    }, 50))
                  : ((n.style.height = "".concat(
                    ...
                    e._bindAnimationEndEvent(n, function () {
                      if ((n.classList.remove("open"), a(), i))
                        for (
                          var e = n.querySelectorAll(".menu-item.open"),
                            t = 0,
                            l = e.length;
                          t < l;
                          t++
            ...
            },
            {
              ...
              get: function () {
                for (
                  var e = this._inner.childNodes, t = 0, n = 0, i = e.length;
                  n < i;
                  n++
                )
                  e[n].tagName &&
                    (t += Math.round(e[n].getBoundingClientRect().width));
                return t;
              },
            },
            {
                ...
                if ("vertical" === t) {
                  ...
                  (this._horizontal = !1),
                    ...
                    (_ = s.classList).add.apply(
                      _,
                      ["layout-menu", "menu", "menu-vertical"].concat([
                        this._menuBgClass,
                      ])
                    ),
                ...
                if (
                  (t.classList.contains("menu-item")
                    ...
                    : t.classList.contains(o) &&
                      (i = t.parentNode.classList.contains("menu-item")
                        ? t.parentNode
                        : null),
                  !i)
                )
