...
include_once $_SERVER['DOCUMENT_ROOT'] . '/elite/features/controller_user.php';
    ...
    <div class="app-brand demo">
        <a href="<?= $base_url ?>" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img src="<?= $base_url ?>assets/img/icons/brands/fox.png" alt="Logo" style="width: 70px; height: auto;" />
            </span>
            <span class="ms-3 app-brand-text fw-bolder menu-text" style="font-size: large;">MAIN MENU</span>
        </a>
